...
classifiers = {
   ...
   # "HistGradientBoostingClassifier": ensemble.HistGradientBoostingClassifier(),
    ...
    "RandomForestClassifier n=100, Max_leaf = 50": ensemble.RandomForestClassifier(max_leaf_nodes=50, random_state=42),    
    "RandomForestClassifier  n=100, Max_leaf = 100": ensemble.RandomForestClassifier(max_leaf_nodes=100, random_state=42),    
    "RandomForestClassifier n=100, Max_leaf = 200": ensemble.RandomForestClassifier(max_leaf_nodes=200, random_state=42),    
    "RandomForestClassifier (default) n=100, Max_leaf = None": ensemble.RandomForestClassifier(random_state=42),    

    "RandomForestClassifier n=50, Max_leaf = None": ensemble.RandomForestClassifier(n_estimators=50, random_state=42),
    "RandomForestClassifier n=10, Max_leaf = None": ensemble.RandomForestClassifier(n_estimators=10, random_state=42),
    "RandomForestClassifier n=150, Max_leaf = None": ensemble.RandomForestClassifier(n_estimators=150, random_state=42)
